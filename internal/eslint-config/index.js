...
export default defineConfig([
  ...
  },
  {
    files: [
      ...
      'packages/theme-slate/**/*.{js,ts}'
    ],
    ignores: ['packages/theme-slate/README.md/*'],
    rules: {
      'no-restricted-imports': [
        'error',
        {
  ...
  },
  {
    files: [
      ...
      'packages/cck-ui/**/*.{js,jsx,ts,tsx,vue}'
    ],
    rules: {
      'no-restricted-imports': [
        'error',
        {
          ...
          patterns: [
            ...
            {
              group: [
                '@cck-ui/theme-slate/**/*.scss',
                '!@cck-ui/theme-slate/src/*.scss',
                '@cck-ui/theme-slate/src/cck-*.scss'
              ],
              message: 'Use @cck-ui/theme-slate/src/*.scss instead.'
            },
            {
              group: [
