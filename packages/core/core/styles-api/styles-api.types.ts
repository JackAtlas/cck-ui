import { CTheme, FactoryPayload, PartialVarsResolver } from '@cck-ui/core'
...
export type Attributes<Payload extends FactoryPayload> =
...
export interface CompoundStylesApiProps<
  Payload extends FactoryPayload
