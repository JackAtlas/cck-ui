...
import { BoxProps, CFontSize, ElementProps, Factory, StylesApiProps } from '../../core'

export type TitleOrder = 1 | 2 | 3 | 4 | 5 | 6
export type TitleSize = `h${TitleOrder}` | Properties['fontSize'] | CFontSize
...
export interface TitleProps
  extends BoxProps, StylesApiProps<TitleFactory>, /* @vue-ignore */ ElementProps<'h1', 'color'> {
  /**
