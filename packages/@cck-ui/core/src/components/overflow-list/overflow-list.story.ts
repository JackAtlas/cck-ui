...
export const ReorderRecompute: Story = {
  render: () => ({
    ...
    setup() {
      ...
      const data = ref(short)
      const toggle = () => {
        data.value = data.value === short ? reordered : short
      }
      return { data, toggle }
    },
    template: `
      <div style="padding: 40px;">
        ...
        <div data-testid="container" style="width: 320px; border: 2px solid var(--c-color-red-filled); padding: 4px;">
